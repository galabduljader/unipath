...
export function videos(lang: Lang) {
  ...
  const defs = [
    ...
    { course: "CS 360", en: "Databases — Full Course", ar: "قواعد البيانات — دورة كاملة", source: "freeCodeCamp", len: "8h 04m", tone: "#7A5AA8" },
...
export function tutors(lang: Lang) {
  const ar = lang === "ar";
  const defs = [
    { name: "Maryam Al-Hashemi", en: "Statistics & Machine Learning", ar: "الإحصاء وتعلّم الآلة", rating: "5.0", sessions: 142, av: "#7A5AA8", initials: "MH" },
