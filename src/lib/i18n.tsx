...
const EN = {
    ...
    upTitle: "Upload your major sheet", upSub: "We'll read your degree plan — requirements, credits and prerequisites — and map exactly where you stand.", dropHere: "Drop your degree sheet here", constraints: "PDF, DOCX, or a photo · up to 10MB", browse: "Browse files", useSample: "Use a sample sheet",
...
const AR: Dict = {
    ...
    upTitle: "ارفع كشف تخصصك", upSub: "سنقرأ خطتك الدراسية — المتطلبات والساعات والمتطلبات السابقة — ونحدّد موقعك بدقة.", dropHere: "اسحب كشف الدرجة هنا", constraints: "PDF أو DOCX أو صورة · حتى ١٠ ميجابايت", browse: "تصفّح الملفات", useSample: "استخدم نموذجاً تجريبياً",
